...
def spawn_team_runtime(
    ...
    *,
    build_coding_decider: Callable[[argparse.Namespace, Any], Any],
    load_skills_from_args: Callable[[argparse.Namespace], Any],
    ...
    decider = build_coding_decider(args, load_skills_from_args(args))
...
def run_team_run_command(
    ...
    *,
    ...
    runtime, team_root, teammate_specs = spawn_team_runtime(
        args,
        build_coding_decider=build_coding_decider,
        load_skills_from_args=load_skills_from_args,
    )
